...
await withTemporaryWorkspace(async ({ temporary, run: runChild, waitForCancellation }) => {
  const run = (command, arguments_, cwd, env = {}) =>
    runChild(command, arguments_, cwd, { ...environment, ...env });
