...
First publication requires the maintainer to establish npm package ownership and complete the trusted-publisher setup. Do not run `npm publish` or create a release as part of an ordinary contribution. See the repository workflows and release documentation as they are introduced for the authoritative operational steps.
